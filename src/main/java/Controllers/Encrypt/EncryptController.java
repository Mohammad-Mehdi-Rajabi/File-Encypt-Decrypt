package Controllers.Encrypt;


import Core.Encrypt.Encrypt;
import Main.Encrypt.Main;
...
public class EncryptController implements Initializable {
    ...
    @FXML
    void onActionEncryptBtn(ActionEvent event) {
        if (passwordTxt.getText().equals("")) {
            ...
            try {
                Encrypt.encrypt(sourceTxt.getText(), distTxt.getText(), passwordTxt.getText());
                s.append("<p class=\"success\">Encryption complete:" + "<br>");
                s.append("<p class=\"success\">Source File:  -> " + Encrypt.sourcePath + "<br>");
                s.append("<p class=\"success\">Distention File:  -> " + Encrypt.distPath + "<br>");
                s.append("<p class=\"black\">-----------------------------------------------------------------------------</p><br>");
                logWebView.getEngine().loadContent(s.toString());
            } catch (InvalidKeySpecException e) {
                s.append("<p class=\"error\">something wrong" + "<br>");
                s.append("<p class=\"black\">-----------------------------------------------------------------------------</p><br>");
                logWebView.getEngine().loadContent(s.toString());
